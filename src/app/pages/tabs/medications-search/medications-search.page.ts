...
import { toEnglishName } from '../../../utlities/toEn';
import { ActivatedRoute, RouterModule } from '@angular/router';
import { AppComponent } from 'src/app/app.component';
import { AuthService } from 'src/app/services/auth.service';

@Component({
  selector: 'app-medications-search',
  templateUrl: 'medications-search.page.html',
  styleUrls: ['medications-search.page.scss'],
  standalone: true,
  imports: [
    IonicModule,
    FormsModule,
...
export class MedicationsSearchPage {
  ...
  prepareUI() {
    this.app.shouldShowTabs$.next(true);
